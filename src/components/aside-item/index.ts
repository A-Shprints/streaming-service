...
export class AsideItem {
    ...
    private svgIcon: string | null;
    private text: string; 
    private path: string;

    constructor(svgIcon: string | null, text: string, path: string) {
    ...
    getTemplate(): string {
        ...
        <li class="aside__item">
            <button class="aside__btn aside__tabs-btn" data-path="${this.path}">
