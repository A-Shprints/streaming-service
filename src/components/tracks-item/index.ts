...
export class TracksItem {
    ...
    getTemplate() {
        ...
        <li class="tracks__item flex">
          <div class="tracks__item__number">${this.index + 1}</div>
          <div class="tracks__item__name"><img class="track__img" src="${this.track.picture}" alt="${this.track.name}">
            <div class="track__content">
              <h3 class="track__name">
                <a class="track__name__link" href="#">${this.track.name}</a>
              </h3>
              <span class="track__author">${this.track.artist}</span>
            </div>
          </div>
          <div class="tracks__item__albom">${this.track.album}</div>
          <div class="tracks__item__data flex">
            <span class="data__text">${this.track.dateAdded}</span>
            <button class="track__like-btn ${this.track.isLiked ? 'like-btn--active' : ""}">
