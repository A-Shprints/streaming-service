import "./style.css"
import headerUserImgUrl from "./user.jpg"
...
private element:HTMLElement | null = null;
    ...
    getTemplate() {
        return `
            <button id="header-user" class="header__user">
                <img class="header__user__img" src="${headerUserImgUrl}" alt="Изображение пользователя">
